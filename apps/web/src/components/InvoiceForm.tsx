...
import { Plus, Trash2, Send, Receipt, Component, Save, Building, CreditCard } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="bg-surface-lowest rounded-2xl shadow-sm border border-black/5 overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
              <div className="md:col-span-2">
                ...
                <input type="text" className="w-full px-3 py-2 border-b-2 border-gray-200 focus:border-primary focus:outline-none transition-colors" defaultValue="COMERCIALIZADORA DE INSUMOS INDUSTRIALES SA DE CV" />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">RFC</label>
                <input type="text" className="w-full px-3 py-2 border-b-2 border-gray-200 focus:border-primary focus:outline-none uppercase font-bold" defaultValue="CII1810243K1" maxLength={13} />
              </div>
              
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Régimen Fiscal</label>
                <select className="w-full px-3 py-2 border-b-2 border-gray-200 focus:border-primary focus:outline-none bg-transparent">
              ...
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 border-b-2 border-gray-200 focus:border-primary focus:outline-none tabular-nums" defaultValue="64000" maxLength={5} />
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-4 space-y-6">
           ...
           <div className="bg-surface-lowest rounded-2xl shadow-sm border border-black/5 p-6">
              ...
              <div className="space-y-4 text-sm">
                 <div>
                    ...
                    {metodoPago === 'PPD' && <p className="text-[11px] text-amber-600 mt-1 mt-1">Con PPD se obliga a FormaPago = 99 y requerirá Complemento de Pago posterior.</p>}
                 </div>
           ...
           <div className="bg-surface-highest rounded-2xl shadow-inner border border-black/5 p-6">
              ...
              <button className="w-full mt-8 bg-primary hover:bg-primary-container text-white px-6 py-4 rounded-xl font-bold font-body transition-colors flex items-center justify-center gap-2 shadow-sm text-lg">
